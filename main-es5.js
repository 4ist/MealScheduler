...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppMealSchedulerMealSchedulerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function MealSchedulerComponent_mat_spinner_46_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-spinner", 20);
      }
    }

    function MealSchedulerComponent_li_48_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var MealSchedulerComponent = /*#__PURE__*/function () {
      function MealSchedulerComponent(http) {
        ...
        this.http = http;
        this.loading = false; //TODO add a config setting to make these easier to change
      ...
      _createClass(MealSchedulerComponent, [{
        ...
        value: function getRoomNumbers() {
          this.loading = true; //document.getElementById('matSpinner').hidden = false;
        ...
        value: function callForRoomNumbers(day, mealTime) {
          ...
          var route = this.liveEndpoint + "/api/".concat(day, "/").concat(mealTime);
          this.http.get(route) //text
          .subscribe(function (data) {
            _this.roomNumbers = data; //document.getElementById('matSpinner').hidden = true;
